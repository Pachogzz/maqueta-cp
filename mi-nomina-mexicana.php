				...
				<div class="row mb-5">
					<div class="col-12 col-md-6">
						...
						<div class="bg-grey0 mb-5 p-5">
							<p class="display-12"><strong>GAT nominal de 0.50% y GAT real de -2.85% antes de impuestos</strong>. La GAT real es el rendimiento que obtendrás después de descontar la inflación estimada. Para fines informativos y de comparación exclusivamente con monto de ahorro de $1,500.00 en adelante. Fecha de cálculo del 30 de Enero al 05 de Febrero del 2020.</p>
