...
<section class="after-flange header-title-inner bg-gradient-green">
	<div class="container h-100">
		<div class="row h-100 align-items-center">
			<div class="col">
				<h1 id="sectionTitle" class="display-4 br-30">Consejo de Vigilancia</h1>
			</div>
		</div>
	</div>
</section> <!-- /. Page Title -->

<?php include('inc/navs/inner_nav_page-crd20.php'); ?>

<section class="page-content">
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<img src="assets/img/secciones/dirigentes/principal-candidatos-al-consejos-vigilancia.jpg" alt="" class="img-fluid mb-5">
			</div>
		</div>  <!-- ./ End Row -->

		<div class="row mb-5">
			<div class="col-12 col-md-6 offset-md-3 text-center py-3">
				<h3 class="title-medium font-weight-bold">CONOCE A LOS CANDIDATOS</h3>
				<p class="lead font-weight-semibold">Selecciona al candidato que quieres ver en video</p>
