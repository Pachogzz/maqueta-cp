		...
		<section class="after-flange header-title-inner bg-gradient-green">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 class="display-4 bg-primary d-inline-block px-lg-5 py-lg-3 br-30 text-white font-weight-semibold">Crédito Credinámico CPM</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
				...
				<div class="row">
					<div class="col-12 col-md-6">
						...
						<div class="bg-grey0 p-5 mb-5">
							<p class="display-12"><strong>Costo Anual Total Promedio de 25.1% sin IVA</strong>. Para fines informativos y de comparación exclusivamente. <strong>Fecha de cálculo 30 de Junio de 2019.</strong></p>
								...
								<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionCICPM">
									<div class="card-body bg-grey0 p-4">
										...
										<ul class="p-5 bg-white bw-1 border-grey1">
											...
											<li>Hasta 20,000 UDIS (Al 31 de enero de 2019, importe $124,951.90] UDIS [Unidad de inversión que se actualiza mensualmente para su conversión en moneda nacional].</li>
										</ul>
										<h4>Plazo</h4>
										<ul class="p-5 bg-white bw-1 border-grey1">
									...
									<div class="card-body bg-grey0 p-4">
										<ul class="p-5 bg-white bw-1 border-grey1">
											...
											<li><strong>CAT Promedio Creédito Personal Plus CPM</strong>
												<p><strong>Costo Anual Total Promedio de 25.1% sin IVA.</strong> Para fines informativos y de comparación exclusivamente. <strong>Fecha de cálculo 30 de Junio de 2019.</strong></p>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="card">
								...
								<div id="collapseFourt" class="collapse" aria-labelledby="headingThree" data-parent="#accordionCICPM">
									<div class="card-body bg-grey0 p-4">
										...
										<h4>Condiciones</h4>
										<ul class="p-5 bg-white bw-1 border-grey1">
											<li>Requiere un pago mínimo mensual.</li>
											<li>No podrá otorgarse al socio más de un crédito de este producto a la vez.</li>
										</ul>
