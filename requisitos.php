<?php include('inc/header.php'); ?>
		...
		<!-- <section class="after-flange header-title-inner" style="background-image: url('assets/img/secciones/socio/cpm-socio.jpeg');background-position: center right;background-size: cover;background-repeat: no-repeat;"> -->
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 class="display-4 bg-primary d-inline-block px-lg-5 py-lg-3 br-30 text-white font-weight-semibold">REQUISITOS</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 offset-md-2">
						<p class="h3 text-center w-100 font-weight-semibold">SÉ PARTE DE LA COOPERATIVA DE AHORRO Y PRÉSTAMO MÁS GRANDE DE MÉXICO</p>
					</div>
				</div>
			</div>
				...
				<div class="row bg-grey0 m-0 pl-0 pt-0 pr-3 pb-3">
					<div class="col-12 col-md-4 pl-0">
						<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							<a class="nav-link h4 p-md-3 br-30 br-tl-0 br-bl-0 active" id="v-One-tab" data-toggle="pill" href="#v-One" role="tab" aria-controls="v-One" aria-selected="true">Requisitos y documentación</a>
							<a class="nav-link h4 p-md-3 br-30 br-tl-0 br-bl-0" id="v-Two-tab" data-toggle="pill" href="#v-Two" role="tab" aria-controls="v-Two" aria-selected="true">Consideraciones en el ingreso</a>
							<a class="nav-link h4 p-md-3 br-30 br-tl-0 br-bl-0" href="soy-menor-de-edad.php">Soy menor de edad</a>
							<a class="nav-link h4 p-md-3 br-30 br-tl-0 br-bl-0" href="ubica-tu-sucursal.php">Ubica tu sucursal</a>
						</div>
					</div>
					<div class="col-12 col-md-8">
						<div class="tab-content py-5" id="v-pills-tabContent">
							<div class="tab-pane fade show active" id="v-One" role="tabpanel" aria-labelledby="v-One-tab">
							...
							<div class="tab-pane fade" id="v-Two" role="tabpanel" aria-labelledby="v-Two-tab">
								<ul class="p-5 bg-white bw-1 border-grey1">
									<li>Brinda tu número fijo o celular.</li>
									...
									<li>Mi compromiso con mi cooperativa
										<ul>
