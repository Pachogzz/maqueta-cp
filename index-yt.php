					...
					<div class="col-md-12 mb-3 mb-lg-5">
						...
						<div class="row">
							<div class="col-md-6 col-lg-7 offset-lg-1 mr-lg-n5 has-label">
								<img src="assets/img/banner-principal-sei-20200916.jpg" class="img-fluid" alt="Yo hago Click, con Caja Popular Mexicana">
							</div>
...
<?php include('inc/home-slider-second.php') ?>
