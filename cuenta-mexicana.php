<?php include('inc/header.php'); ?>
		...
		<section class="after-flange header-title-inner" style="background-image: url('assets/img/secciones/header-bg-orange.jpeg');background-position: center; background-size: cover; background-repeat: no-repeat;">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 class="display-4 bg-primary d-inline-block px-lg-5 py-lg-3 br-30 text-white font-weight-semibold">Cuenta Mexicana</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
								...
								<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionCICPM">
									<div class="card-body bg-grey0 p-4">
										<ul class="p-5 bg-white bw-1 border-grey1">
											<li>Tu ahorro ganará intereses que se verán reflejados en tu ahorro cada mes.</li>
											<li>El incremento constante en tu Cuenta Mexicana te permitirá obtener créditos con intereses y plazos accesibles.</li>
