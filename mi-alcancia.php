			...
			<div class="container">
				<div class="row mb-3 mb-lg-5">
					<div class="col-12 text-center">
						<img src="assets/img/secciones/ahorro/mi_alcancia_1.jpg" alt="" class="mx-auto img-fluid">
								...
								<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionCICPM">
									<div class="card-body bg-grey0 p-4">
										<ul class="p-5 bg-white bw-1 border-grey1">
											<li>Al establecer un plan o finalidad a lograr (el cual se plasmará en el comprobante de apertura), se establecerá el monto por el cual realizarás tus depósitos en el tiempo que lo decidas.</li>
											<li>El cálculo de interés se realiza diariamente, capitalizando al final del plazo el rendimiento de tu ahorro.</li>
						...
						<div class="row">
							<div class="col-12 mt-5">
								...
								<div class="bg-grey0 p-5">
									<p class="display-12">Vigencia del <strong>26 de Marzo al 1 de Abril del 2020</strong></p>
							...
							<table class="table text-center">
								...
								<tbody>
									<tr>
										...
										<td>Marzo</td>
										<td>26/03/2020 al 01/04/2020</td>
									</tr>
									<tr>
