		...
		<section class="after-flange header-title-inner bg-gradient-blue">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 class="display-4 bg-primary d-inline-block px-lg-5 py-lg-3 br-30 text-white font-weight-semibold">Soy Menor de Edad</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 offset-md-2">
						<p class="h3 text-center w-100 font-weight-semibold">SI ERES MENOR DE 18 AÑOS PERO QUIERES INICIAR CON EL HÁBITO DEL AHORRO, TENEMOS UNA OPCIÓN PARA TI COMO AHORRADOR MENOR DE EDAD</p>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-md-6">
						<img src="https://via.placeholder.com/1980x550.jpg/ccc/333?text=Banner+x2" alt="Banner Placeholder" class="img-fluid mt-3">
					</div>
					<div class="col-12 col-md-6">
						<img src="https://via.placeholder.com/1980x550.jpg/ccc/333?text=Banner+x2" alt="Banner Placeholder" class="img-fluid mt-3">
					</div>
