							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<div class="h-100 w-100 text-center">
										<img class="m-auto" src="assets/img/secciones/menor-de-edad/cpm-ahorrador-menor-de-edad-testimonio-1.png" alt="First slide">
									</div>
								</div>
								<div class="carousel-item">
									<div class="h-100 w-100 text-center">
										<img class="m-auto" src="assets/img/secciones/menor-de-edad/cpm-ahorrador-menor-de-edad-testimonio-2.png" alt="Second slide">
									</div>
								</div>
							</div>
						...
						<ul id="responsiveTab" class="nav nav-pills justify-content-center icon-tabs responsive-tabs">
							...
							<li class="nav-item">
								<a class="nav-link text-center h4 p-3" href="#v-Two">
									<i class="fas fa-clipboard-list fa-3x mb-3"></i><br>Requisitos
								</a>
							</li>
							<li class="nav-item">
				...
				<div class="row mb-5">
					...
					<div class="col-6 col-md-3 mb-3 mb-lg-0">
						<div class="h-100 w-100 rounded bw-5 border-grey0">
							<a href="https://www.facebook.com/GeneraccionCPM/" target="_blank" class="h-100 w-100 text-primary d-flex align-items-center text-center py-4 py-lg-0">
					...
					<div class="col-6 col-md-3 mb-3 mb-lg-0">
						<div class="h-100 w-100 rounded bw-5 border-grey0">
							<a href="https://www.instagram.com/generaccioncpm/" target="_blank" class="h-100 w-100 text-primary d-flex align-items-center text-center py-4. py-lg-0">
