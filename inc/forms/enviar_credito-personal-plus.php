<?php
    								...
    								<table border='0' width='600' cellpadding='0' cellspacing='0' class='container' style='width:600px;max-width:600px;'>
    									...
    									<tr>
    										<td class='container-padding content' align='left' style='padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff'>
    											<br>
    											<div class='title' style='font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;color:#374550'>Crédito Personal Plus CPM - Solicitud de información</div>
    											<br>
	...
	if ($captcha_success->success) {
		...
		echo "<script> 
                ...
                window.location.href='https://cpm.coop/credito-personal-plus-cpm';
            </script>";
        // header("Location:http://localhost/cpm-html/credito-personal-plus-cpm");
