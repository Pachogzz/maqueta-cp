		...
		<header id="site-header" class="d-none d-md-none d-lg-block">
			...
			<div class="container">
				<nav class="navbar navbar-expand-lg">
					...
					<a class="navbar-brand" href="index"><img class="main-logo" src="assets/img/cpm-logo.png" alt="Logotipo - Caja Popular Mexicana"></a>
					...
					<div class="collapse navbar-collapse" id="navbar">
						<ul id="main-nav" class="navbar-nav ml-auto">
							...
							<li class="nav-item">
								<a href="ubica-tu-sucursal" class="nav-link btn btn-outline-light py-1 ml-1" alt="Ubica tu sucursal" title="Ubica tu sucursal"><i class="fa fa-map-marker-alt"></i></a>
							</li>
							<!-- <li class="nav-item">
									...
									<div class="row">
										<div class="col-12 col-lg-4">
											...
											<ul class="nav flex-column">
												<li class="nav-item">
													<a href="conocenos" class="nav-link">Somos Caja Popular Mexicana</a>
												</li>
												<li class="nav-item">
										...
										<div class="col-12 col-lg-4">
											...
											<ul class="nav flex-column">
												...
												<li class="nav-item"><a href="servicio-electronico-en-linea" class="nav-link">Servicio Electrónico por Internet</a></li>
					...
					<div class="col-12">
						<div class="collapse" id="menuMobile">
							<ul class="list-group">
								...
								<li class="list-group-item"><a href="ubica-tu-sucursal"><i class="fa fa-map-marker-alt"></i> Ubica tu sucursal</a></li>
								...
								<li class="nav-item"><a href="asambleas" class="nav-link">Asambleas</a></li>
								...
								<li class="list-group-item"><a href="servicio-electronico-en-linea">Servicio Electrónico por Internet</a></li>
								...
								<li class="list-group-item"><a href="puntos-verdes">Puntos Verdes</a></li>
