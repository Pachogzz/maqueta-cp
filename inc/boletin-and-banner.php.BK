			...
			<div class="container">
				<div class="row">
						...
						<div class="row mx-lg-1 mb-3 mb-md-0 px-3 py-5 p-md-5 p-lg-5 bg-tertiary br-bl-30">
							...
							<div class="col-md-6 col-lg-7">
								...
								<div id="mc_embed_signup">
									<form action="https://cpm.us13.list-manage.com/subscribe/post?u=929b8338b3f2ba53253936d83&amp;id=22a1d8e15a" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
									    <div id="mc_embed_signup_scroll">
											<div class="mc-field-group form-group">
												<input type="text" value="" name="FNAME" class="form-control" id="mce-FNAME" placeholder="Nombre completo:">
											</div>
											<div class="mc-field-group form-group">
					...
					<div class="col-12 col-lg-4 p-0 px-md-3">
						<img src="assets/img/secciones/beneficios-box-banner.jpg" alt="Banner Placeholder" class="img-fluid">
					</div>
				</div>
			</div>
