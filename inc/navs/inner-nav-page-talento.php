				...
				<div class="row text-center">
					<div class="col-12 col-lg z-index-1">
						<a href="#" class="btn btn-primary btn-lg btn-block rounded-pill w-100 w-lg-75 mx-auto p-3 mb-2 mb-lg-0 active">
							Talento <i class="fa fa-chevron-circle-right"></i>
						</a>
					</div>
					<div class="col-12 col-lg p-0 pl-md-0 pl-lg-3 mb-2 mb-lg-0 white-circle-n-line">
						<a href="talento-cpm.php" class="btn bg-tertiary btn-lg btn-block w-100 rounded-0 py-3 px-0 text-white">
							Ser CPM
						</a>
					</div>
					<div class="col-12 col-lg p-0 mb-2 mb-lg-0 ">
						<a href="beneficios-ser-cpm.php" class="btn bg-primary btn-lg btn-block w-100 rounded-0 py-3 px-0 text-white">
							Beneficios
						</a>
					</div>
					<div class="col-12 col-lg p-0 mb-2 mb-lg-0 ">
					...
					<div class="dropdown col-12 col-lg p-0 mb-2 mb-lg-0 ">
						<a href="https://talento.cpm.coop/viewalljobs/" class="btn bg-quaternary btn-lg btn-block w-100 rounded-0 py-3 px-0 text-white">Ofertas de trabajo</a>
