			...
			<div class="container">
				<div class="row text-center">
					...
					<div class="col-12 col-lg p-0 pl-md-0 pl-lg-3 mb-2 mb-lg-0 white-circle-n-line">
						<a href="talento-cpm" class="btn bg-tertiary btn-lg btn-block w-100 rounded-0 py-3 px-0 text-white">
							Ser CPM
						</a>
					</div>
					<div class="col-12 col-lg p-0 mb-2 mb-lg-0 ">
						<a href="beneficios-ser-cpm" class="btn bg-primary btn-lg btn-block w-100 rounded-0 py-3 px-0 text-white">
							Beneficios
						</a>
					</div>
					<div class="col-12 col-lg p-0 mb-2 mb-lg-0 ">
