    ...
    window.eqfeed_callback = function(results) {
        ...
        for (var i = 0; i < results.features.length; i++) {
            ...
            // var banner4 = results.features[i].properties.imagen4;
            // var info4 = results.features[i].properties.texto4;
            // var link4 = results.features[i].properties.ver_mas4;
                ...
                if (inpmun == municipio.toUpperCase()) {
                    ...
                    if (existe) {
                        ...
                        var datainsert = datainfo
                            ...
                            .replace('*link3*', link3)
                            .replace('*link4*', link4)
                            .replace('*dasamblea*', dasamblea)
                            .replace('*fasamblea*', fasamblea)
                            .replace('*hasamblea*', hasamblea)
                        ;
