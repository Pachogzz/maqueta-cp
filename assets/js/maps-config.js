        ...
        for (var i = 0; i < results.features.length; i++) {
            ...
            if (inpest == estado.toUpperCase()) {
                if (inpmun == municipio.toUpperCase()) {
                    ...
                    if (existe) {
                        var datainfo = "<div class='col-12 px-0 px-lg-auto'><div class='card w-100 rounded-0' style='margin-bottom: 15px;'><div class='card-header bg-tertiary text-white py-2 px-3'><h5 class='card-title my-1 data-info d-inline-block'>*sucursal*</h5><input type='button' class='btn btn-primary btn-sm datos-maker float-right' value='Ver en mapa' target='*localizacion*'></div><div class='card-body py-2 px-3'><p class='card-text data-info'><strong class='text-tertiary'>Dirección:</strong>  *direccionfinal*</p></div><ul class='list-group list-group-flush'><li class='list-group-item py-2 px-3 data-info'><strong class='text-tertiary'>Teléfono: </strong> (*lada*) *tel*</li><li class='list-group-item py-2 px-3 data-info'><strong class='text-tertiary'>Horarios: </strong>*horariolv*<br>*horariosb*<br>*horariodm*</li><li class='list-group-item py-2 px-3 data-info'><strong class='text-tertiary'>Servicios: </strong> *servicios*.</li></ul><div class='card-body py-2 px-3 data-info'><div id='carouselExampleControls' class='carousel slide' data-ride='carousel'><div class='carousel-inner' id='carousel-inner'><div class='carousel-item active data-info'><img class='d-block w-100 bbw'  src='*banner*' alt='*ccarousel*' id='slide-uno'><p class='data-info my-2 px-2'>*info1*</p><a href='*link1*' target='_blank' class='d-block w-100 text-center'><input type='button' class='btn btn-primary btn-sm datos-maker m-auto' value='Ver m&aacute;s'></a></div><div class='carousel-item  data-info'><img class='d-block w-100 bbw' src='*banner2*' alt='*ccarousel*' id='slide-dos'><p class='data-info my-2 px-2'>*info2*</p><a href='*link2*' target='_blank' class='d-block w-100 text-center'><input type='button' class='btn btn-primary btn-sm datos-maker' value='Ver m&aacute;s'></a></div><div class='carousel-item  data-info'><img class='d-block w-100 bbw' src='*banner3*' alt='*ccarousel*' id='slide-tres'><p class='data-info my-2 px-2'>*info3*</p><a href='*link3*' target='_blank' class='d-block w-100 text-center'><input type='button' class='btn btn-primary btn-sm datos-maker' value='Ver m&aacute;s'></a></div></div><a class='carousel-control-prev' href='#carouselExampleControls' role='button' data-slide='prev'><i class='fas fa-chevron-left'></i></a><a class='carousel-control-next' href='#carouselExampleControls' role='button' data-slide='next'><i class='fas fa-chevron-right'></i></a></div></div><div class='card-body py-2 px-3'><p class='card-text data-info'><strong class='text-tertiary'>Direcci&oacute;n Asamblea:</strong>  *dasamblea*</p></div><div class='card-body py-2 px-3'><p class='card-text data-info'><strong class='text-tertiary'>Fecha:</strong>  *fasamblea*</p></div><div class='card-body py-2 px-3'><p class='card-text data-info'><strong class='text-tertiary'>Hora:</strong>  *hasamblea*</p></div><!--div class='card-body py-2 px-3'></div--></div>";
