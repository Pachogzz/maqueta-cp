									...
									<div class="card-body bg-grey0 p-4">
										<ul class="p-5 bg-white bw-1 border-grey1">
											<p><strong>Tarjeta de Débito</strong></p>
												...
												<p><strong>Tarjeta de débito JR.</strong><p>
											...
											<li><strong>Generalidades</strong>
												<p>Por cuestiones de seguridad, al adquirir tu tarjeta, cambia el NIP (Número de Identificación Personal), en los cajeros automáticos de Caja Popular Mexicana o en los Cajeros RED que lo permitan.</p>
												<p>Activación inmediata de la tarjeta.</p>
												<p>Reportar si utilizarás tu tarjeta en el extranjero, para evitar el bloqueo de la misma por seguridad.</p>
												<p>Para mayor seguridad en tus transacciones, acude a tu sucursal a remplazar tu Tarjeta de Débito de banda por la nueva tarjeta con chip.</p>
											</li>
										</ul>
									</div>
								</div>
