		...
		<section class="after-flange header-title-inner">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 class="display-4 bg-primary d-inline-block px-lg-5 py-lg-3 br-30 text-white font-weight-semibold">Crédito Inmediato CPM</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
				...
				<div class="row">
					<div class="col">
						<blockquote class="blockquote mb-5 p-5 border border-light bw-5 rounded border-grey1 text-center">
							<p class="mb-0 lead font-weight-normal">Informar a los usuarios sobre los requisitos, beneficios, tasas <br>y consideraciones que deben tomar en cuenta para contratar un <br>Crédito Inmediato CPM.</p>
						</blockquote>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-12 col-md-6 order-md-1">
						<div class="has-label p-5">
							...
							<p class="lead">Obtén un crédito inmediato, de igual o <br>
							menor monto a tu ahorro, con una tasa <br>
							muy accesible.</p>
							<p class="lead"><strong>¡Crédito al instante! Montos desde <br>
							$1,000.00 hasta $30,000,000.00</strong></p>
						</div>
