		...
		<section class="after-flange header-title-inner bg-gradient-green">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 class="display-4 bg-primary d-inline-block px-lg-5 py-lg-3 br-30 text-white font-weight-semibold">Crédito Hipotecario CPM</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
			...
			<div class="container">
				<div class="row">
					<div class="col-12 text-center">
						<img src="assets/img/secciones/creditos/CPM_hipotecario_banner_1891x426px.jpg" alt="" class="img-fluid mb-5">
					</div>
				</div> <!-- ./ End Row -->
				<div class="row">
					<div class="col-12 col-md-6">
						...
						<div class="bg-grey0 p-5 mb-5">
							<p class="display-12"><strong>Costo Anual Total Promedio a 12.9% sin IVA</strong>. para finalidades de vivienda | <strong>24.3% </strong> para finalidades de liquidez. Para fines informativos y de comparación exclusivamente. <strong>Fecha de cálculo 30 de Junio de 2019.</strong></p>
