		...
		<section class="after-flange header-title-inner bg-gradient-green">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 class="display-4 br-30">Rendicuenta</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
			...
			<div class="container">
				<div class="row">
					<div class="col-12 text-center">
						...
						<img src="assets/img/secciones/ahorro/rendicuenta.jpg" alt="" class="img-fluid mb-5">
				...
				<div class="row">
					<div class="col-12 col-md-6">
						...
						<div class="has-label pb-5 pt-0 px-5 position-relative">
							...
							<p class="lead">Consulta los <span class="font-weight-bold text-primary">Consulta los costos y comisiones de nuestro producto <a href="costos-y-comisiones-de-nuestro-producto.php">aquí </a></span></p>
