		...
		<section class="after-flange header-title-inner bg-gradient-green">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 id="sectionTitle" class="display-4 br-30">Rendicuenta</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
			...
			<div class="container">
				<div class="row mb-3 mb-lg-5">
					<div class="col-12 text-center">
						<img class="mx-auto img-fluid" src="assets/img/secciones/ahorro/rendicuenta_20200907.jpg" alt="CPM - Rendicuenta - Plazos de 30 a 180 días.">
								...
								<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionCICPM">
									<div class="card-body bg-grey0 p-4">
										<ul class="p-5 bg-white bw-1 border-grey1">
											<li>Puedes abrir tu Rendicuenta con tan solo $2,000.00</li>
											<li>El saldo de tus Rendicuentas podrá formar parte de las garantías para futuros préstamos.</li>
											<li>El hábito del ahorro proporciona la posibilidad de formar tu patrimonio y lograr una estabilidad económica.</li>
											<li>Gana utilidades sobre el dinero que no tienes en movimiento.</li>
											<li>Rendicuenta te ofrece un excelente interés por tu inversión, logrando atractivos rendimientos a su vencimiento.</li>
											<li>Puedes disponer de tu ahorro en más de 470 sucursales.</li>
											<li>Al vencimiento de tu Rendicuenta, podrás transferirlo a alguna de tus cuentas, retirarlo en efectivo o por tu seguridad retirarlo en un cheque.</li>
											<li>Consulta los plazos de Rendicuenta que también te dan <a href="http://www.puntosverdes.mx">Puntos Verdes.</a></li>
											<li>Ahora puedes recibir tus intereses en periodos intermedios al vencimiento en los plazos de 180, 360, 720 y 1080 días.</li>
											<li>Con la contratación o reinversión de la Rendicuenta podrás participar en las promociones de sucursal, consulta las bases y fechas de vigencia.</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="card">
								...
								<div id="collapseFourt" class="collapse" aria-labelledby="headingThree" data-parent="#accordionCICPM">
									<div class="card-body bg-grey0 p-4">
										...
										<ul class="p-5 bg-white bw-1 border-grey1">
											<li>Ahorrar en esta cuenta te sirve como base principal para el otorgamiento de futuros créditos.</li>
											<li>El hábito del ahorro proporciona la posibilidad de formar tu patrimonio y lograr una estabilidad económica.</li>
											<li>Ahorra entre el 5% y 10% de tus ingresos como previsión para futuras necesidades.</li>
											<li>Sólo podrás retirar tu inversión el día de la renovación o vencimiento de la Rendicuenta.</li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="nav nav-pills tab-cpm-style1 mt-5" id="pills-tab" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link font-weight-semibold" id="tabEight-tab" data-toggle="pill" href="#tabEight" role="tab" aria-controls="tabEight" aria-selected="false">720 días</a>
							</li>
							<li class="nav-item">
								<a class="nav-link font-weight-semibold" id="tabNine-tab" data-toggle="pill" href="#tabNine" role="tab" aria-controls="tabNine" aria-selected="false">1080 días</a>
							</li>
						</ul>
						<div class="tab-content tab-cpm-style1" id="pills-tabContent">
							...
							<div class="tab-pane fade" id="tabEight" role="tabpanel" aria-labelledby="tabEight-tab">
								<!-- Nota Legal Tabla -->
								<!-- Tabla 720 días -->
								<div class="table-responsive">
									<table class="table text-center">
							...
							<div class="tab-pane fade" id="tabNine" role="tabpanel" aria-labelledby="tabNine-tab">
								<!-- Nota Legal Tabla -->
								<!-- Tabla 1080 días -->
								<div class="table-responsive">
									<table class="table text-center">
