		...
		<section class="after-flange header-title-inner bg-gradient-orange">
			<div class="container h-100">
				<div class="row h-100 align-items-center">
					<div class="col">
						<h1 class="display-4 bg-primary d-inline-block px-lg-5 py-lg-3 br-30 text-white font-weight-semibold">Cuentamiga</h1>
					</div>
				</div>
			</div>
		</section> <!-- /. Page Title -->
								...
								<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionCICPM">
									<div class="card-body bg-grey0 p-4">
										<ul class="p-5 bg-white bw-1 border-grey1">
											<li>Cuentamiga te ofrece una atractiva tasa de interés que verás reflejada en tu saldo mensualmente.</li>
											<li>Si eres menor de 12 años, podrás disponer de tu dinero en nuestras más de 470 sucursales acompañado de tu padre o tutor.</li>
											<li>Si eres mayor de 12 años, lo podrás hacer con una autorización por escrito.</li>
										</ul>
									</div>
								</div>
							</div>
