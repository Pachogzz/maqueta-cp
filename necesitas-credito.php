		...
		<section class="landing-grid">
			<div class="container">
				<div class="row row-eq-height">
					...
					<div class="landing-grid-box col-12 col-md-4">
						<div class="landing-grid-box-info rounded bw-5 border-quinary text-center h-100">
							<img src="assets/img/icons/icon-bills.png" class="bg-quinary p-3 rounded-circle" width="120" height="120" alt="">
					...
					<div class="landing-grid-box col-12 col-md-4">
						<div class="landing-grid-box-info rounded bw-5 border-quinary text-center h-100">
							<img src="assets/img/icons/icon-clock.png" class="bg-quinary p-3 rounded-circle" width="120" height="120" alt="">
							<h3>Crédito <br>Inmediato CPM</h3>
							<p>Obtén un crédito inmediato, de igual o menor monto a tu ahorro, con una tasa muy accesible.</p>
						</div>
					</div>
				</div>
				<div class="row row-eq-height">
					...
					<div class="landing-grid-box col-12 col-md-4 mb-0">
						<div class="landing-grid-box-info rounded bw-5 border-quinary text-center h-100">
							<img src="assets/img/icons/icon-group-people.png" class="bg-quinary p-3 rounded-circle" width="120" height="120" alt="">
					...
					<div class="landing-grid-box col-12 col-md-4 mb-0">
						<div class="landing-grid-box-info rounded bw-5 border-quinary text-center h-100">
							<img src="assets/img/icons/icon-car.png" class="bg-quinary p-3 rounded-circle" width="120" height="120" alt="">
							<h3>Crédito Automotriz</h3>
							<p>Adquiere el automóvil que tú quieras, ya sea nuevo o seminuevo para uso personal o productivo.</p>
						</div>
					</div>
				</div>
			</div>
